...
st.markdown("""
<div class='info-card'>
    <b style='color:#60a5fa; font-size:1.05rem;'>📐 저항 연결 개념 유도 및 가상 실습 Sequence</b><br>
    <span style='color:#e2e8f0; font-size:0.92rem; line-height: 1.6;'>
    이 단원에서는 저항의 직렬 및 병렬 연결에 대해 단계별 흐름 학습과 3D 가상 실험을 진행합니다.<br>
    <b>1. 직렬/병렬 공식 학습 ➡️ 2. 개념 자가 진단 평가 ➡️ 3. Tinkercad 3D 입체 브레드보드 실무 실습</b>으로 연계되어, 수학적 수식 유도에서 가상 실험으로의 부드러운 전이를 돕습니다.
    </span>
</div>
""", unsafe_allow_html=True)

# 탭 구조 설계 (직렬 연결 공식, 병렬 연결 공식, 개념 자가 진단 평가, Tinkercad 3D 가상 실험실)
tab_series, tab_parallel, tab_concept_quiz, tab_tinkercad = st.tabs([
...
# ==============================================================
# 탭 4: Tinkercad 3D 가상 실험실
# ==============================================================
with tab_tinkercad:
    st.markdown("<h3 style='color: #e2e8f0;'>🌐 Tinkercad 3D 입체 브레드보드 가상 실험실</h3>", unsafe_allow_html=True)
    st.markdown("<p style='color: #94a3b8; font-size: 0.9rem;'>웹 브라우저 상에서 실제 브레드보드, 저항 소자, 디지털 멀티미터, 가변 직류 전원장치를 직접 연결하고 실시간으로 회로 전류와 전압을 계측할 수 있습니다.</p>", unsafe_allow_html=True)
    
    st.markdown("""
    <div style='background: linear-gradient(135deg, #1e293b, #0f172a); border: 2.5px solid #f59e0b; border-radius: 14px; padding: 25px; margin-top: 15px; box-shadow: 0 4px 18px rgba(245, 158, 11, 0.15);'>
        <div style='display: flex; align-items: center; gap: 12px; margin-bottom: 12px;'>
            <span style='font-size: 1.8rem;'>🌐</span>
            <b style='color: #f59e0b; font-size: 1.25rem; font-family: sans-serif;'>Tinkercad 3D 입체 브레드보드 가상 실험실 연계</b>
        </div>
        <p style='color: #cbd5e1; font-size: 0.95rem; line-height: 1.6; margin-bottom: 20px;'>
            선생님이 사전에 설계해 놓은 브레드보드 실습 화면으로 즉각 연결됩니다. <br>
            아래의 주황색 버튼을 클릭하여 새 창으로 열리는 가상 실험실에서 직접 저항의 직렬/병렬 연결을 실험해 보세요!
        </p>
        <a href="https://www.tinkercad.com/things/hmjoLbPvgti-?sharecode=nznZz3WZGs26hxTKSJySse5jnIPqxuegE9cpiayXOrA" target="_blank" style="text-decoration: none;">
            <div style="background: linear-gradient(135deg, #f59e0b, #d97706); color: #0f172a; text-align: center; padding: 15px 20px; border-radius: 10px; font-weight: 800; font-size: 1.05rem; cursor: pointer; transition: 0.2s; box-shadow: 0 3px 10px rgba(245, 158, 11, 0.25);">
