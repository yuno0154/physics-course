        ...
        <script type="text/babel">
            ...
            const QUESTIONS_DATA = [
                ...
                },
                {
                    ...
                    type: 'multiple_sub_questions',
                    title: '원운동 물리량 계산',
                    text: '반지름(r)이 2m이고 질량이 2kg인 물체가 v = 2π m/s의 속력으로 등속 원운동하고 있습니다.',
                    view: 'circular_calc',
                    items: [
                        { 
                            label: '1. 각속도(ω)는 얼마인가?', 
                            type: 'choice', 
                            options: ['0.5π rad/s', 'π rad/s', '2π rad/s', '3π rad/s'],
                            correct: 1 
                        },
                        { 
                        ...
                        { 
                            label: '3. 구심 가속도의 크기는?', 
                            type: 'choice', 
                            options: ['π² m/s²', '2π² m/s²', '4π² m/s²', '0.5π² m/s²'],
                            correct: 1 
                        }
                    ]
                },
            ...
            const EXPLANATIONS = {
                ...
                q2: "1. v = rω 에서 ω = v/r = 2π / 2 = π rad/s 입니다.\\n2. T = 2π / ω = 2s 입니다.\\n3. a = v²/r = (2π)² / 2 = 2π² m/s² 입니다.",
                q3: "속도 성분이 sin, cos 파형을 그리며 한 주기를 도는 데 걸리는 시간은 2t₀입니다. t = t₀일 때 vx = 0이고 vy는 최대 음수(-)이므로 가속도(중심 방향)는 -x 방향이 됩니다.",
