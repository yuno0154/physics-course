                        ...
                        <div className="bg-slate-900 p-8 rounded-[2.5rem] mt-4 shadow-2xl animate-in fade-in slide-in-from-top-4 duration-500">
                            ...
                            <div className="grid grid-cols-4 gap-4">
                                <div>
                                    ...
                                    <input type="text" className="w-full bg-slate-800 text-white p-4 rounded-2xl outline-none font-bold" placeholder="예: 3" value={studentInfo.grade} onChange={e=>setStudentInfo({...studentInfo, grade: e.target.value})} />
                                </div>
                                <div>
